classdef Input < wasm.dom.Element
    ...
    methods        
        ...
        function value = getChecked(obj)
            ...
            cppInput = coder.opaque("std::shared_ptr<mathworks::wasm::dom::Input>","NULL","HeaderFile","dom/input.h");
            cppInput = coder.ceval("std::static_pointer_cast<mathworks::wasm::dom::Input>",obj.cppElement); 
                                    
            value = false;
            value = coder.ceval(...
                'std::mem_fn(&mathworks::wasm::dom::Input::checked)',cppInput);
        ...
        function setValue(obj,value)
            ...
            coder.ceval(...
                'std::mem_fn(&mathworks::wasm::dom::Input::setValue)',...
                cppInput,valueStr);   
        end
        ...
        function value = getValue(obj)
            ...
            valueStr = coder.ceval(...
                'std::mem_fn(&mathworks::wasm::dom::Input::value)',cppInput);     
        ...
        function addChangeEventListener(obj,callbackFcnName)
            ...
            cond = coder.const(wasm.project.isCallback(string(callbackFcnName),'UIEvent'));
